...
public class TsetmcMarketService {
    ...
    @Cacheable(
            ...
            key = "T(com.ernoxin.bourseapi.cache.TsetmcCacheKeys).marketIdAndLimit(#marketId, #limit)",
            sync = true
    )
    ...
    @Cacheable(
            cacheResolver = "tsetmcCacheResolver",
            key = "T(com.ernoxin.bourseapi.cache.TsetmcCacheKeys).clientType(#instrumentCode, #clientTypeParam1, #clientTypeParam2)",
            sync = true
    )
    ...
    @Cacheable(
            cacheResolver = "tsetmcCacheResolver",
            key = "T(com.ernoxin.bourseapi.cache.TsetmcCacheKeys).instrumentCodeAndDays(#instrumentCode, #days)",
            sync = true
    )
    ...
    @Cacheable(
            cacheResolver = "tsetmcCacheResolver",
            key = "T(com.ernoxin.bourseapi.cache.TsetmcCacheKeys).instrumentCodeAndPeriod(#instrumentCode, #period)",
            sync = true
    )
    ...
    @Cacheable(
            cacheResolver = "tsetmcCacheResolver",
            key = "T(com.ernoxin.bourseapi.cache.TsetmcCacheKeys).sectorCode(#sectorCode)",
            sync = true
    )
